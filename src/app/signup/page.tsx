...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 px-4 overflow-hidden relative">
      ...
      <div className="absolute -top-32 -left-32 w-80 h-80 bg-gradient-to-br from-purple-200/30 to-indigo-200/30 rounded-full blob" />
      <div className="absolute -bottom-32 -right-32 w-80 h-80 bg-gradient-to-br from-green-200/20 to-cyan-200/20 rounded-full blob" style={{ animationDelay: "3s" }} />
      ...
      <div className="w-full max-w-md animate-scale-in relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Use your .edu email to get started</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100/80 p-7 space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all disabled:opacity-50 shadow-lg shadow-indigo-200/50 hover:shadow-xl hover:shadow-indigo-300/50 hover:-translate-y-0.5 active:translate-y-0"
          >
            {loading ? (
