...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      {/* Course search bar */}
      <div ref={searchRef} className="relative mb-5 animate-slide-up stagger-1">
      ...
      {/* Course chip filters - horizontal scroll */}
      <div className="flex gap-2 mb-6 overflow-x-auto pb-2 scrollbar-hide animate-slide-up stagger-2">
        <button
        ...
        <div className="bg-white rounded-2xl border border-dashed border-gray-200 p-12 text-center animate-scale-in">
          ...
          <p className="text-sm text-gray-400">
            {selectedCourseId
              ...
              : "Check back soon for new offerings from your campus."}
          </p>
        </div>
      ) : (
        <div className="space-y-4">
          {listings.map((listing, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 px-5 pt-5 pb-3">
                <div className="w-11 h-11 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-full flex items-center justify-center shadow-sm ring-2 ring-white">
